    ...
    <div className={`w-full ${className}`}>
      <div className="flex justify-between items-center border-b border-[#ffffff1a] relative">
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`relative px-6 py-4 text-[15px] font-medium transition-all duration-300 
                ${activeTab === tab.id 
                  ? "text-white after:absolute after:bottom-0 after:left-0 after:w-full after:h-[2px] after:bg-primary after:rounded-t-full rgb-glow"
                  : "text-[#ffffff80] hover:text-white rgb-glow-subtle"
                }
        ...
        <Link
          ...
          className="flex items-center gap-x-1 py-1 px-2 -mr-2 rounded-md rgb-glow-subtle
